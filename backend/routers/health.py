...
async def install_ffmpeg():
    """Auto-install FFmpeg for the user."""
    ...
    try:
        if system == "Darwin":
            # macOS: Try brew first, then download static binary
            ...
            # Download static binary to app data dir
            ...
            # Set env so ffmpeg_path.py picks it up
            ...
            raise HTTPException(400, "Auto-install not yet supported on Windows. Please install FFmpeg manually.")
...
async def install_ollama():
    """Auto-install Ollama for the user."""
    ...
    try:
        if system == "Darwin":
            ...
            raise HTTPException(400, "Auto-install not yet supported on Windows. Please install Ollama manually.")
